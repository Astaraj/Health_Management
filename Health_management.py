...
def take(k):
    if k == 1:
        ...
        if (c == 1):
            ...
            with open("Lucky_ex.txt", "a") as op:
                op.write(str(getdate()) + ": " + value + "\n")
            print("Successfully written")
        elif (c == 2):
            value = input("Type here\n")
            with open("Lucky_food.txt", "a") as op:
...
#retrive input from client
def retrieve(k):
    if k == 1:
        c = int(input("Enter 1 for excersise and 2 for food: "))
        if (c == 1):
            with open("Lucky_ex.txt") as op:
                for i in op:
                    print(i, end = "")
        elif (c == 2):
            with open("Lucky_food.txt") as op:
                for i in op:
                    print(i, end = "")
    elif (k == 2):
        c = int(input("Enter 1 for excersise and 2 for food: "))
