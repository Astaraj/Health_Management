...
while num_of_chance<chance:
    ...
    if human == system:
        human_point+=1
        system_point+=1
        print(f"\nYour choice is {human} and system choice is {system} \nso Tie")
...
if human_point<system_point:
    print(f"\nsystem win game led by {system_point} points")

elif human_point>system_point:
    print(f"\nHuman win game led by {human_point} points")

else:
    print(f"\nGame DRAW both gets {human_point} points")